...
class CameraDocPageTwo extends StatelessWidget {
  const CameraDocPageTwo({super.key});
    ...
    return Stack(
      ...
      children: [
        const DocumentView(
          index: "2 / 4",
          title: '장비 리스트',
          subTitle: '촬영부 필요 장비 목록',
          content: cameraDocTwoText,
        ),
        Container(
          padding: const EdgeInsets.fromLTRB(50, 80, 22, 130),
          alignment: Alignment.bottomRight,
          child: const ImagePreview(imageName: 'camera_2'),
        ),
        Positioned(
          bottom: 50,
          child: FileDownloadButton(
              documentUrl: cameraTwo,
              color: cameraColor),
        ),
      ],
    );
