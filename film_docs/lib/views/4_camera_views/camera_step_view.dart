...
class CameraStepView extends StatelessWidget {
  final ScrollController _scrollController = ScrollController();

  CameraStepView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: mainBlack,
        title: const Text('촬영부 프로덕션 단계', style: subtitle1),
      ...
      body: SingleChildScrollView(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ThreeDotsOnLine(
                  dotColor: cameraColor, scrollToText: (text) => ScrollHelper.scrollToText(context, _scrollController, text)),
              ...
              const Text(cameraPreP, style: body1),
              ...
              const SizedBox(height: 6),
              const Text(cameraP, style: body1),
              const SizedBox(height: 40),
              Container(
              ...
              const SizedBox(height: 6),
              const Text(cameraPostP, style: body1),
            ],
          ),
        ),
      ),
