...
class DirectorDocPageOne extends StatelessWidget {
  const DirectorDocPageOne({super.key});
    ...
    return Stack(
      ...
      children: [
        const DocumentView(
          index: "1 / 5",
          title: '씬 리스트',
          subTitle: '씬의 세부 내용을 나열한 목록',
          content: directorDocOneText,
        ),
        Container(
          padding: const EdgeInsets.fromLTRB(50, 80, 22, 130),
          alignment: Alignment.bottomRight,
          child: const ImagePreview(imageName: 'director_1'),
        ),
        Positioned(
          bottom: 50,
          child: FileDownloadButton(
              documentUrl: directorOne,
              color: directorColor),
        ),
      ],
    );
