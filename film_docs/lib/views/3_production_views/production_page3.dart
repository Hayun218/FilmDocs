...
class ProductionDocPageThree extends StatelessWidget {
  const ProductionDocPageThree({super.key});
    ...
    return Stack(
      ...
      children: [
        const DocumentView(
          index: "3 / 4",
          title: '스태프 리스트',
          subTitle: '모든 스태프의 정보를 정리해둔 문서',
          content: productionDocThreeText,
        ),
        Container(
          padding: const EdgeInsets.fromLTRB(50, 80, 22, 130),
          alignment: Alignment.bottomRight,
          child: const ImagePreview(imageName: 'production_3'),
        ),
        Positioned(
          bottom: 50,
          child: FileDownloadButton(
              documentUrl: productionThree,
