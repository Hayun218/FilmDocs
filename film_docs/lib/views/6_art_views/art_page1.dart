...
class ArtDocPageOne extends StatelessWidget {
  const ArtDocPageOne({super.key});
    ...
    return Stack(
      ...
      children: [
        const DocumentView(
          index: "1 / 3",
          title: '소품 리스트',
          subTitle: '미술부 필요 소품 목록',
          content: artDocOneText,
        ),
        Container(
          padding: const EdgeInsets.fromLTRB(50, 80, 22, 130),
          alignment: Alignment.bottomRight,
          child: const ImagePreview(imageName: 'art_1'),
        ),
        Positioned(
          bottom: 50,
